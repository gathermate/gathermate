...
CHANNELS = [
dict(cid='ALLTHEKPOP',name='ALL THE K-POP',chnum=607,pooq='M10',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/19_all the KPOP.png'),
dict(cid='ANIBOX',name='ANIBOX',chnum=993,kt=993,lg=695,sky=84,pooq='C4401',logo='http://img.pooq.co.kr/BMS/ChannelImg/32_애니박스.png'),
...
dict(cid='CHANNELW',name='채널W',chnum=116,kt=116,lg=161,sky=518,pooq='C3901',logo='http://img.pooq.co.kr/BMS/ChannelImg/33_채널w.png'),
...
dict(cid='EBS-KIDS',name='EBS KIDS',chnum=983,kt=983,lg=608,pooq='E05',logo='http://img.pooq.co.kr/BMS/ChannelImg/ebs키즈.png'),
dict(cid='EBS-FM',name='라디오 EBS 교육방송',chnum=500,pooq='E06',logo='http://img.pooq.co.kr/BMS/ChannelImg/50_EBS fm.png'),
...
dict(cid='JTBC-GOLF',name='JTBC Golf',chnum=56,kt=56,lg=602,sky=974,pooq='C2302',tving='C00588',logo='http://img.pooq.co.kr/BMS/ChannelImg/43_jtbc Golf.png'),
...
dict(cid='KBS-DRAMA',name='KBS DRAMA',chnum=35,kt=35,sky=910,pooq='K06',logo='http://img.pooq.co.kr/BMS/ChannelImg/11_kbs Drama.png'),
dict(cid='KBS-JOY',name='KBS JOY',chnum=41,kt=41,lg=619,sky=968,pooq='K04',logo='http://img.pooq.co.kr/BMS/ChannelImg/12_kbs Joy.png'),
dict(cid='KBSN-LIFE',name='KBSN Life',chnum=281,kt=281,lg=582,sky=291,pooq='K05',logo='http://img.pooq.co.kr/BMS/ChannelImg/13_kbs N life.png'),
...
dict(cid='KBSW',name='KBS W',chnum=83,kt=83,lg=620,sky=509,pooq='K09',logo='http://img.pooq.co.kr/BMS/ChannelImg/14_kbs W.png'),
dict(cid='KBS1-RADIO',name='KBS1 RADIO',chnum=501,pooq='K07',logo='http://img.pooq.co.kr/BMS/ChannelImg/44_kbs 1 radio.png'),
dict(cid='KBS2-RADIO',name='KBS2 FM',chnum=502,pooq='K08',logo='http://img.pooq.co.kr/BMS/ChannelImg/45_KBS coolFM.png'),
dict(cid='KBS-1NIGHT2DAYS',name='KBS 1박 2일',chnum=400,pooq='K15',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/25_kbs1박2일.png'),
...
dict(cid='KISS-HOT',name='KISS - 최신인기가요',chnum=601,pooq='C2701',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/51_Kiss 최신인기가요.png'),
dict(cid='KISS-BALLAD',name='KISS - 발라드',chnum=602,pooq='C2702',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/52_Kiss 발라드.png'),
dict(cid='KISS-8090',name='KISS - 8090인기가요',chnum=603,pooq='C2703',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/unnamed.png'),
dict(cid='KISS-IDOL',name='KISS - K-POP 아이돌',chnum=604,pooq='C2704',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/C2704.png'),
dict(cid='KISS-2000',name='KISS - 2000년대 인기가요',chnum=605,pooq='C2705',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/55_Kiss 2000년대인기가요.png'),
dict(cid='KISS-JAZZ',name='KISS - 재즈 라운지',chnum=606,pooq='C2706',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/56_Kiss all that jazz.png'),
...
dict(cid='MBC-DRAMANET',name='MBC 드라마넷',chnum=3,kt=3,lg=621,sky=857,pooq='M02',logo='http://img.pooq.co.kr/BMS/ChannelImg/17_MBC drama.png'),
dict(cid='MBC-EVERYONE',name='MBC EVERY1',chnum=1,kt=1,lg=626,sky=58,pooq='M03',logo='http://img.pooq.co.kr/BMS/ChannelImg/18_MBC every1.png'),
dict(cid='MBC-MUSIC',name='MBC Music',chnum=97,kt=97,lg=624,sky=126,pooq='M06',logo='http://img.pooq.co.kr/BMS/ChannelImg/16_MBC music.png'),
dict(cid='MBC-RADIO',name='MBC 표준 FM',chnum=503,pooq='M07',logo='http://img.pooq.co.kr/BMS/ChannelImg/46_MBC 표준fm.png'),
dict(cid='MBC-FM4U',name='MBC FM4U',chnum=504,pooq='M08',logo='http://img.pooq.co.kr/BMS/ChannelImg/47_MBC fm4U.png'),
dict(cid='MBC-INFINITECHALLENGE',name='MBC 무한도전',chnum=410,pooq='PM1',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/23_MBC 무한도전.png'),
...
dict(cid='PLAYY-WELLMADE',name='PLAYY 웰메이드 영화',chnum=440,pooq='H01',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/28_playy월메이드영화.png'),
dict(cid='PLAYY-ACTION',name='PLAYY 액션영화',chnum=441,pooq='H07',only='pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/29_playy액션영화.png'),
...
dict(cid='SBS-FUNE',name='SBS funE',chnum=43,kt=43,lg=615,sky=858,pooq='S04',logo='http://img.pooq.co.kr/BMS/ChannelImg/20_sbs FunE.png'),
dict(cid='SBS-PLUS',name='SBS Plus',chnum=37,kt=37,lg=612,sky=767,pooq='S03',logo='http://img.pooq.co.kr/BMS/ChannelImg/21_sbs Plus.png'),
dict(cid='SBS-MTV',name='SBS MTV',chnum=96,kt=96,lg=634,sky=130,pooq='S09',logo='http://img.pooq.co.kr/BMS/ChannelImg/22_sbs MTV.png'),
dict(cid='SBS-SPORTS',name='SBS Sports',chnum=58,kt=58,lg=613,sky=977,pooq='S02',logo='http://img.pooq.co.kr/BMS/ChannelImg/42_sbs Sports.png'),
dict(cid='SBS-CNBC',name='SBS CNBC',chnum=25,kt=25,lg=616,sky=622,pooq='S06',logo='http://img.pooq.co.kr/BMS/ChannelImg/06_sbs CNBC.png'),
dict(cid='SBS-POWERFM',name='SBS 파워FM',chnum=505,pooq='S07',logo='http://img.pooq.co.kr/BMS/ChannelImg/48_sbs 파워fm.png'),
dict(cid='SBS-LOVEFM',name='SBS 러브FM',chnum=506,pooq='S08',logo='http://img.pooq.co.kr/BMS/ChannelImg/49_sbs 러브fm.png'),
...
dict(cid='SPOTV-GAMES',name='SPOTV GAMES',chnum=124,kt=124,lg=727,pooq='C5401',logo='http://img.pooq.co.kr/BMS/ChannelImg/스포TV.png'),
...
dict(cid='YONHAPNEWS',name='연합뉴스TV',chnum=23,kt=23,lg=734,sky=566,pooq='Y01',tving='C01723',logo='http://img.pooq.co.kr/BMS/ChannelImg/05_연합뉴스TV.png'),
...
dict(cid='HYUNDAI',name='현대홈쇼핑',chnum=10,kt=10,lg=675,sky=493,pooq='C4101',logo='http://img.pooq.co.kr/BMS/ChannelImg/61_현대홈쇼핑.png'),
dict(cid='HYUNDAI-PLUSSHOP',name='현대홈쇼핑+샵',chnum=36,kt=36,lg=760,sky=930,pooq='C4102',only='kt|lg|pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/62_현대홈쇼핑plus샵.png'),
...
dict(cid='SHOPPINGANDT',name='쇼핑엔T',chnum=33,kt=33,lg=782,sky=41,pooq='C4901',only='kt|lg|pooq',logo='http://img.pooq.co.kr/BMS/ChannelImg/63_쇼핑엔티.png'),
